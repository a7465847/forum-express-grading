...
const passport = require('../config/passport')
  ...
  router.get('/users/:id/edit', authenticated, permissionAccess, userController.editUser)
  router.put('/users/:id', authenticated, permissionAccess, upload.single('image'), userController.putUser)
